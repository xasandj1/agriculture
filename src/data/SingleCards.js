...
export const SingleCards = [
    ...
    {
        id: 10,
        img: images.WhiteHazelnut,
        title: "White Hazelnut",
        sale: "$20.00",
        price: "$13.00",
        icon: Stars,
        btn: "Fresh", txt: "Simply dummy text of the printing and typesetting industry. Lorem had ceased to been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley.",
        quntity: "Quantity :",
        add: "Add To Cart"
    },
    {
